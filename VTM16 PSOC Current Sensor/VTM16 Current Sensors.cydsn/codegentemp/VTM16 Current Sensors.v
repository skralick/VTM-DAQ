...
// ADC_SAR_v3_0(ADC_Clock=0, ADC_Clock_Frequency=10105264, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=true, Ref_Voltage=2.425, Ref_Voltage_mV=2425, rm_int=true, Sample_Precharge=4, Sample_Rate=0, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq_1:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=ADC_SAR_Seq_1_SAR, )
...
module ADC_SAR_SEQ_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("8ce05789-c615-40b0-87fb-0429454e7a88/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module EZI2C_v2_0_3 (
    ...
    cy_psoc3_i2c_v1_0 I2C_Prim (
        ...
        .sda_out(Net_173),
        .interrupt(Net_172));
    defparam I2C_Prim.use_wakeup = 1;
...
module top ;
	...
	wire [0:0] tmpOE__Overall_Production_net;
	wire [0:0] tmpFB_0__Overall_Production_net;
	wire [0:0] tmpIO_0__Overall_Production_net;
	wire [0:0] tmpINTERRUPT_0__Overall_Production_net;
	electrical [0:0] tmpSIOVREF__Overall_Production_net;
	...
	cy_psoc3_pins_v1_10
		...
		Overall_Production
		 (.oe(tmpOE__Overall_Production_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Overall_Production_net[0:0]}),
		  .analog({Net_355}),
		  .io({tmpIO_0__Overall_Production_net[0:0]}),
		  .siovref(tmpSIOVREF__Overall_Production_net),
		  .interrupt({tmpINTERRUPT_0__Overall_Production_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Overall_Production_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Overall_Consumption_net;
	wire [0:0] tmpFB_0__Overall_Consumption_net;
	wire [0:0] tmpIO_0__Overall_Consumption_net;
	wire [0:0] tmpINTERRUPT_0__Overall_Consumption_net;
	electrical [0:0] tmpSIOVREF__Overall_Consumption_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  ...
		  .input_buffer_sel(2'b00))
		Overall_Consumption
		 (.oe(tmpOE__Overall_Consumption_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Overall_Consumption_net[0:0]}),
		  .analog({Net_7}),
		  .io({tmpIO_0__Overall_Consumption_net[0:0]}),
		  .siovref(tmpSIOVREF__Overall_Consumption_net),
		  .interrupt({tmpINTERRUPT_0__Overall_Consumption_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Overall_Consumption_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    ADC_SAR_SEQ_v2_0_2 ADC_SAR_Seq_1 (
        .soc(1'b0),
        .aclk(1'b0),
        .sdone(Net_548),
        .eoc(Net_549),
	...
	wire [0:0] tmpOE__Fuel_Pump_net;
	wire [0:0] tmpFB_0__Fuel_Pump_net;
	wire [0:0] tmpIO_0__Fuel_Pump_net;
	wire [0:0] tmpINTERRUPT_0__Fuel_Pump_net;
	electrical [0:0] tmpSIOVREF__Fuel_Pump_net;

	cy_psoc3_pins_v1_10
		#(.id("ada4dc70-83ab-4070-8759-ffb5efe8533a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Fuel_Pump
		 (.oe(tmpOE__Fuel_Pump_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Fuel_Pump_net[0:0]}),
		  .analog({Net_357}),
		  .io({tmpIO_0__Fuel_Pump_net[0:0]}),
		  .siovref(tmpSIOVREF__Fuel_Pump_net),
		  .interrupt({tmpINTERRUPT_0__Fuel_Pump_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Fuel_Pump_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Fuel_Injector_net;
	wire [0:0] tmpFB_0__Fuel_Injector_net;
	wire [0:0] tmpIO_0__Fuel_Injector_net;
	wire [0:0] tmpINTERRUPT_0__Fuel_Injector_net;
	electrical [0:0] tmpSIOVREF__Fuel_Injector_net;

	cy_psoc3_pins_v1_10
		#(.id("35017d7f-2bb8-4065-8776-844bfac9a2b1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Fuel_Injector
		 (.oe(tmpOE__Fuel_Injector_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Fuel_Injector_net[0:0]}),
		  .analog({Net_358}),
		  .io({tmpIO_0__Fuel_Injector_net[0:0]}),
		  .siovref(tmpSIOVREF__Fuel_Injector_net),
		  .interrupt({tmpINTERRUPT_0__Fuel_Injector_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Fuel_Injector_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ignition_net;
	wire [0:0] tmpFB_0__Ignition_net;
	wire [0:0] tmpIO_0__Ignition_net;
	wire [0:0] tmpINTERRUPT_0__Ignition_net;
	electrical [0:0] tmpSIOVREF__Ignition_net;

	cy_psoc3_pins_v1_10
		#(.id("f6a33b17-7902-4f07-88d4-612309d09c4d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Ignition
		 (.oe(tmpOE__Ignition_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ignition_net[0:0]}),
		  .analog({Net_456}),
		  .io({tmpIO_0__Ignition_net[0:0]}),
		  .siovref(tmpSIOVREF__Ignition_net),
		  .interrupt({tmpINTERRUPT_0__Ignition_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ignition_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("943ec90a-5164-4631-89be-7a41553b8564"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
